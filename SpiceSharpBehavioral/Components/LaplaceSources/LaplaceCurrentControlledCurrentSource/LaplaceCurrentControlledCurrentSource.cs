...
using SpiceSharp.Components.LaplaceCurrentControlledCurrentSourceBehaviors;
...
namespace SpiceSharp.Components
{
    ...
    /// </summary>
    public class LaplaceCurrentControlledCurrentSource : Component<LaplaceBehaviors.Parameters>,
        ...
        IRuleSubject
    {
        ...
        public LaplaceCurrentControlledCurrentSource(string name)
            : base(name, PinCount)
        {
        }
        ...
        public LaplaceCurrentControlledCurrentSource(string name, string pos, string neg, string voltageSource,
