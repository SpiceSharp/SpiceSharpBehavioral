...
using SpiceSharp.Components.LaplaceVoltageControlledCurrentSourceBehaviors;
...
namespace SpiceSharp.Components
{
    ...
    /// </summary>
    public class LaplaceVoltageControlledCurrentSource : Component<LaplaceBehaviors.Parameters>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LaplaceVoltageControlledCurrentSource"/>.
        /// </summary>
        /// <param name="name"></param>
        public LaplaceVoltageControlledCurrentSource(string name)
            : base(name, PinCount)
        {
        }
        ...
        public LaplaceVoltageControlledCurrentSource(string name, string pos, string neg, string controlPos, string controlNeg,
