...
{
    [TestFixture]
    public class LaplaceCurrentControlledCurrentSourceTests
    {
        [Test]
        public void When_Static_Expect_Reference()
        {
            var ckt = new Circuit(
                ...
                new CurrentControlledCurrentSource("F1", "ref", "0", "V1", 2.0),
                new Resistor("Rref", "ref", "0", 1.0),
                new LaplaceCurrentControlledCurrentSource("F2", "act", "0", "V1", new[] { 2.0 }, new[] { 1.0 }),
        ...
        public void When_TransientRC_Expect_Reference()
        {
            var ckt = new Circuit(
                ...
                new CurrentSource("I1", "ai", "0", new Pulse(0, 1, 1e-6, 1e-9, 1e-9, 1e-6, 2e-6)),
                new LaplaceCurrentControlledCurrentSource("F1", "act", "0", "V2", new[] { 1.0 }, new[] { 1.0, 1.0e-3 }),
        ...
        public void When_TransientCR_Expect_Reference()
        {
            ...
            var ckt = new Circuit(
                ...
                new VoltageSource("V2", "ai", "0", 0.0),
                new CurrentSource("I1", "ai", "0", new Pulse(0, 1, 1e-6, 1e-9, 1e-9, 1e-6, 2e-6)),
                new LaplaceCurrentControlledCurrentSource("F1", "act", "0", "V2", new[] { 0.0, 1.0e-3 }, new[] { 1.0, 1.0e-3 }),
                new Resistor("R2", "act", "0", 1.0));
        ...
        public void When_TransientLC_Expect_Reference()
        {
            var ckt = new Circuit(
                ...
                new VoltageSource("V2", "ai", "0", 0.0),
                new CurrentSource("I1", "ai", "0", new Pulse(0, 1, 1e-6, 1e-9, 1e-9, 1e-6, 2e-6)),
                new LaplaceCurrentControlledCurrentSource("F1", "act", "0", "V2", new[] { 1.0 }, new[] { 1.0, 0.0, 1.0e-6 }),
                new Resistor("R2", "act", "0", 1.0));
        ...
        public void When_ACRC_Expect_Reference()
        {
            var ckt = new Circuit(
                ...
                new LaplaceCurrentControlledCurrentSource("F1", "act", "0", "V1", new[] { 1.0 }, new[] { 1.0, 1e-3 }),
                new Resistor("R2", "act", "0", 1.0));
            ...
            {
                var s = new Complex(0.0, ac.Frequency * 2.0 * Math.PI);
